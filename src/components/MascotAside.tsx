...
export function MascotAside({
  ...
  return (
    ...
    >
      <div
        aria-hidden
        className="pointer-events-none absolute inset-x-[-14%] top-[4%] bottom-[6%] rounded-full blur-2xl"
        style={{
          background:
      ...
      <motion.img
        ...
        decoding="async"
        draggable={false}
        className="relative w-full [filter:drop-shadow(0_16px_24px_rgba(10,46,107,0.2))]"
      ...
      <motion.div
        aria-hidden
        className="pointer-events-none absolute bottom-[1%] left-1/2 h-3 w-[48%] -translate-x-1/2 rounded-[50%] bg-blue-deep/20 blur-md"
